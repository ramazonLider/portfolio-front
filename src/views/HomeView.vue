  ...
  <header class="navbar navbar-top navbar-expand navbar-dark navbar-fixed">
    <div class="container justify-content-between">
      ...
      <ul class="nav nav-gap-sm navbar-nav nav-social align-items-center text-white">
        <li class="nav-item">
          <RouterLink to="https://facebook.com/runwebrun" class="nav-link">
        ...
        <li class="nav-item">
          <RouterLink to="https://twitter.com/runwebrun" class="nav-link">
        ...
        <li class="nav-item">
          <RouterLink to="https://instagram.com/runwebrun" class="nav-link">
  ...
  <div class="navbar navbar-mobile navbar-mobile-style-2 navbar-dark" id="navbar-mobile-style-2">
    ...
    <div class="navbar-head">
      <div class="container justify-content-between">
        ...
        <RouterLink class="navbar-toggle" to="#" data-fancybox-close>
          <span></span>
          <span></span>
          <span></span>
        </RouterLink>
          ...
          <div class="navbar-body">
            <ul class="nav navbar-nav navbar-nav-collapse">
              <li class="nav-item navbar-collapse active">
                <RouterLink to="/" class="nav-link collapsed">
                  <span class="nav-link-name">home</span>
            ...
            <div class="mb-60 text-white">
              ...
              <ul class="list-group borderless font-size-17">
                <li class="list-group-item">
                  Email:
                  <RouterLink to="mailto:hello@themebau.com?subject=Test%20Address%20Email"
                    class="text-decoration-none text-white">hello@themebau.com</RouterLink>
                </li>
                <li class="list-group-item">
                  Phone:
                  <RouterLink to="callto:+1 202-358-0309" class="text-decoration-none text-white">+1 202-358-0309</RouterLink>
                </li>
              </ul>
            </div>
            <div class="mb-60 text-white">
  ...
  <div class="content-wrap">
    <div class="py-160 min-vh-100 d-flex align-items-center position-relative lines-style-3">
      ...
      <div class="background bg-dark">
        ...
        <div class="background-color" style="background-color: #0e0e0e; opacity: 0.2"></div>
      </div>
      <div class="container">
        <div class="row">
