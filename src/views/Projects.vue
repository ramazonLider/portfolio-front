                    ...
                    <div class="navbar-footer">
                        <div class="mb-60">
                            ...
                            <ul class="list-group borderless font-size-17">
                                ...
                                <li class="list-group-item">Phone: <a href="callto:+1 202-358-0309"
    ...
    <div class="content-wrap">
        <div class="container isotope mt-130">
            <ul class="nav justify-content-center isotope-options mb-60 show-on-scroll" data-show-duration="500">
                <li class="nav-item active show-on-scroll" data-show-duration="500" data-show-distance="10"
                    data-show-delay="100">
                ...
                <li class="nav-item show-on-scroll" data-show-duration="500" data-show-distance="10"
                    data-show-delay="150">
                    <a href="#" data-filter="dd" class="nav-link">
                        <div class="nav-link-name">cd</div>
                    </a>
                </li>
                {% endfor %}
            </ul>
            <div class="pt-30 show-on-scroll" data-show-duration="800">
                <div class="row gv-1 isotope-grid">
                    {% for project in projects %}
                    <div class="col-12 isotope-item" data-filters="{{ project.category.name }}"
                        data-cursor-style="cursor-circle" data-cursor-text="view">
                        <a class="card card-portfolio card-overlay card-image-sm card-hover-zoom card-bg-show text-white"
                            ...
                            <span class="card-img-overlay">
                                <svg class='card-logo' width='80' height='40' viewBox='0 0 80 40' fill='none'
                                    xmlns='http://www.w3.org/2000/svg'>
                                ...
                                <span class="card-title h3">jj</span>
                                <span class="card-category subtitle">d</span>
                            </span>
                        </a>
                    </div>
                    {% endfor %}
    ...
    <footer class="footer bg-dark text-white shape-parent overflow-hidden text-center pt-160 pb-60">
        ...
        <div class="container pt-4">
            <ul class="nav align-items-center flex-column text-white mb-100">
                ...
                <li class="nav-item">
                    <a href="callto:+99 758-97-89" class="nav-link h4 mt-8 mt-md-0">+99 758-97-89</a>
                </li>
            </ul>
