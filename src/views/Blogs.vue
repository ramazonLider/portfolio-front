<template>
    <header class="navbar navbar-top navbar-expand-lg navbar-fixed">
        <div class="container justify-content-between">
            <a class="navbar-brand" to="/">
                <img width="107" src="" alt="">
            </a>
            <a class="navbar-toggle" to="#navbar-mobile-style-2" data-fancybox data-base-class="fancybox-navbar"
            ...
            <ul class="nav nav-gap-sm navbar-nav nav-social align-items-center">
                <li class="nav-item">
                    <a to="https://facebook.com/runwebrun" class="nav-link">
                ...
                <li class="nav-item">
                    <a to="https://twitter.com/runwebrun" class="nav-link">
                ...
                <li class="nav-item">
                    <a to="https://instagram.com/runwebrun" class="nav-link">
    ...
    <div class="navbar navbar-mobile navbar-mobile-style-2" id="navbar-mobile-style-2">
        ...
        <div class="navbar-head">
            <div class="container justify-content-between">
                ...
                <a class="navbar-toggle" to="#" data-fancybox-close>
                    <span></span>
                    <span></span>
                    <span></span>
                </a>
                    ...
                    <div class="navbar-body">
                        <ul class="nav navbar-nav navbar-nav-collapse">
                            <li class="nav-item navbar-collapse">
                                <a to="#navbarCollapseHome" class="nav-link collapsed" role="button"
                                    data-bs-toggle="collapse" aria-expanded="false" aria-controls="navbarCollapseHome">
                                    <span class="nav-link-name">home</span>
                            ...
                            <li class="nav-item navbar-collapse active">
                                <a to="#navbarCollapseProjects" class="nav-link collapsed" role="button"
                            ...
                            <li class="nav-item navbar-collapse">
                                <a to="#navbarCollapsePages" class="nav-link collapsed" role="button"
                                    data-bs-toggle="collapse" aria-expanded="false" aria-controls="navbarCollapsePages">
                        ...
                        <div class="mb-60">
                            ...
                            <ul class="list-group borderless font-size-17">
                                <li class="list-group-item">Email: <a
                                        ...
                                        class="text-decoration-none">hello@themebau.com</a></li>
                                <li class="list-group-item">Phone: <a to="callto:+1 202-358-0309"
                                        class="text-decoration-none">+1 202-358-0309</a></li>
                            </ul>
                        </div>
                        <div class="mb-60">
    ...
    <div class="content-wrap">
        <div class="container">
            <div class="pt-60 pb-60 mt-10 mb-2 text-center">
                <h1 class="mt-10 show-on-scroll" data-show-duration="600" data-show-distance="10">Our blog</h1>
            </div>
            <div class="isotope">
                <ul class="nav justify-content-center isotope-options mb-60 pb-30 show-on-scroll"
                    data-show-duration="500" data-show-delay="50">
                    <li class="nav-item active show-on-scroll" data-show-duration="400" data-show-distance="10"
                        ...
                        <a href="#" data-filter="all" class="nav-link">
                            <div class="nav-link-name">all posts</div>
                        </a>
                    </li>
                    <li v-for="part in parts" v-bind:key="part.id" class="nav-item show-on-scroll" data-show-duration="400" data-show-distance="10"
                        data-show-delay="150">
                        <a href="#" :data-filter="part.name" class="nav-link">
                            <div class="nav-link-name">{{ part.name }}</div>
                        </a>
                    </li>
                </ul>
                <div class="row justify-content-center gh-1 show-on-scroll" data-show-duration="700"
                    data-show-delay="250">
                    <div class="col-12 col-lg-10 isotope-grid">
                        <div v-for="blog in blogs" v-bind:key="blog.id"
                            ...
                            <div class="card-body">
                                ...
                                <RouterLink to="" class="btn btn-clean">read more<svg
                                        class='icon-arrow icon-arrow-right' width='25' height='10' viewBox='0 0 25 10'
                                        fill='none' xmlns='http://www.w3.org/2000/svg'>
                                        <path d='M20 1L24 5L20 9' stroke='currentColor' stroke-width='1.3'
                                            stroke-linecap='round' stroke-linejoin='round' />
                                        <path d='M7 5L24 5' stroke='currentColor' stroke-width='1.3'
                                            stroke-linecap='round' stroke-linejoin='round' />
                                    </svg></RouterLink>
                            </div>
                        </div>
    ...
    <footer class="footer bg-dark text-white shape-parent overflow-hidden text-center pt-160 pb-60">
        <div class="shape align-items-end justify-content-center">
            <svg data-rellax-speed="2" width="641" height="371" viewBox="0 0 641 371" fill="none"
                xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="container pt-4">
            <ul class="nav align-items-center flex-column text-white mb-100">
                <li class="nav-item">
                    <a to="mailto:hello@themebau.com?subject=Test%20Address%20Email"
                        class="nav-link h2 mb-8 mb-md-30 d-none d-md-flex">hello@themebau.com</a>
                    <a to="mailto:hello@themebau.com?subject=Test%20Address%20Email"
                        class="nav-link h4 mb-8 mb-md-30 d-md-none">hello@themebau.com</a>
                </li>
                <li class="nav-item">
                    <a to="callto:+99 758-97-89" class="nav-link h4 mt-8 mt-md-0">+99 758-97-89</a>
                </li>
            </ul>
