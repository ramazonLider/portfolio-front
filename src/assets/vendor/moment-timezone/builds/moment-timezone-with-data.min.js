!function (c, M) {
    ...
    function X() {
        for (var c, M, A = (new Date).getFullYear() - 2, o = new W(new Date(A, 0, 1)), z = [o], b = 1; b < 48; b++)
            (M = new W(new Date(A, b, 1))).offset !== o.offset && (c = function (c, M) {
    ...
    function B() {
        ...
        return p.sort(u),
            0 < p.length ? p[0].zone.name : void 0
    }
    function l(c) {
    ...
    function t(c, M) {
        ...
        return o instanceof N ? o : "string" == typeof o ? (o = new N(o),
            a[c] = o) : p[c] && M !== t && (A = t(p[c], t)) ? ((o = a[c] = new N)._set(A),
                o.name = i[c],
                o) : null
    }
    function s(c) {
    ...
    function m(c) {
        return m.didShowError || (m.didShowError = !0,
            S("moment.tz.zoneExists('" + c + "') has been deprecated in favor of !moment.tz.zone('" + c + "')")),
            !!t(c)
    }
    function C(c) {
        var M = "X" === c._f || "x" === c._f;
    ...
    b.tz = R,
        ...
        b.updateOffset = function (c, M) {
            ...
            void 0 === c._z && (z && C(c) && !c._isUTC && (c._d = b.utc(c._a)._d,
                c.utc().add(z.parse(c), "minutes")),
                c._z = z),
                c._z && (o = c._z.utcOffset(c),
                    Math.abs(o) < 16 && (o /= 60),
                    void 0 !== c.utcOffset ? (A = c._z,
                        c.utcOffset(-o, M),
                        c._z = A) : c.zone(o, M))
        }
        ,
